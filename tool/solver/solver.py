...
class Proposer:
    ...
    def invoke(self, task: str) -> AIMessage:
        ...
        builder.add_node("propose", self._graph, input=Solution)
    ...
    def _construct_graph(self) -> None:
        ...
        builder.add_node("compile_solution", self._compiler.compile, input=Solution)
...
class Solver:
    ...
    def _construct_graph(self) -> None:
        ...
        builder.add_node("add_tests", get_tests, input=Solution)
        builder.add_node("propose", self._proposer.graph, input=Solution)

        builder.add_edge(START, "get_requirements")
        builder.add_edge("get_requirements", "recall")
        builder.add_conditional_edges(
            "recall", self._recaller.recalled_or_new, {"new": "add_tests", "recalled": END}
        )
        builder.add_edge("add_tests", "propose")
