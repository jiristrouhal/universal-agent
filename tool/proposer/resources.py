...
from tool.models import TaskWithResources, TaskWithSolutionStructure, ResourceForm
...
class ResourceManager:
    ...
    def get_resources(self, draft: TaskWithSolutionStructure) -> TaskWithResources:
        query = (
            f"Task: {draft.task}\n"
